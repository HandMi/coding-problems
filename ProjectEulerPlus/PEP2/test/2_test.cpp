...
class PEP2_GetNextFibonacciTest
    : public testing::TestWithParam<
          std::pair<std::pair<long long, long long>, long long>>
{
};

TEST_P(PEP2_GetNextFibonacciTest, GetNextFibonacciTest)
{
...
INSTANTIATE_TEST_CASE_P(
    PEP2_GetNextFibonacciTests, PEP2_GetNextFibonacciTest,
    ::testing::Values(std::make_pair(std::make_pair(2,1),3),
                      std::make_pair(std::make_pair(55,34),89)));
// clang-format on

class PEP2_ComputeEvenFibonacciSumTest
    : public testing::TestWithParam<
          std::pair<std::map<long long, long long>, std::vector<long long>>>
{
};

TEST_P(PEP2_ComputeEvenFibonacciSumTest, ComputeEvenFibonacciSumTest)
{
...
// clang-format off
INSTANTIATE_TEST_CASE_P(
    PEP2_ComputeEvenFibonacciSumTests, PEP2_ComputeEvenFibonacciSumTest,
