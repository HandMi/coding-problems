...
class CJ_VestigiumTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(CJ_VestigiumTest, VestigiumTest)
{
...
INSTANTIATE_TEST_CASE_P(
    CJ_VestigiumTests, CJ_VestigiumTest,
    ::testing::Values(std::make_pair("CodeJam/Vestigium/data/0_in.txt","CodeJam/Vestigium/data/0_out.txt"),
                      std::make_pair("CodeJam/Vestigium/data/1_in.txt","CodeJam/Vestigium/data/1_out.txt")));
// clang-format on
