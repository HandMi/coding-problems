...
class CF0131D_GetDistancesFromRingroadTest
    : public testing::TestWithParam<std::pair<Graph, std::vector<int>>>
{
};

TEST_P(CF0131D_GetDistancesFromRingroadTest, GetDistancesFromRingroad)
{
...
INSTANTIATE_TEST_CASE_P(
    CF0131D_GetDistancesFromRingroadTests, CF0131D_GetDistancesFromRingroadTest,
