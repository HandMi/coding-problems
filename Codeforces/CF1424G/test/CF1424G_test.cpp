...
class CF1424G_YearsTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(CF1424G_YearsTest, YearsTest)
{
...
INSTANTIATE_TEST_CASE_P(
    CF1424G_YearsTests, CF1424G_YearsTest,
    ::testing::Values(std::make_pair("Codeforces/CF1424G/data/0_in.txt","Codeforces/CF1424G/data/0_out.txt"),
                      std::make_pair("Codeforces/CF1424G/data/1_in.txt","Codeforces/CF1424G/data/1_out.txt")));
// clang-format on
