...
class CF1472C_LongJumpsTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(CF1472C_LongJumpsTest, LongJumpsTest)
{
...
INSTANTIATE_TEST_CASE_P(
    CF1472C_LongJumpsTests, CF1472C_LongJumpsTest,
    ::testing::Values(std::make_pair("Codeforces/CF1472C/data/0_in.txt","Codeforces/CF1472C/data/0_out.txt")));
// clang-format on
