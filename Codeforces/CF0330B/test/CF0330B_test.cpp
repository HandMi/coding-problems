...
class CF0330B_RoadConstructionTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(CF0330B_RoadConstructionTest, RoadConstructionTest)
{
...
INSTANTIATE_TEST_CASE_P(
    CF0330B_RoadConstructionTests, CF0330B_RoadConstructionTest,
    ::testing::Values(std::make_pair("Codeforces/CF0330B/data/0_in.txt","Codeforces/CF0330B/data/0_out.txt")));
// clang-format on
