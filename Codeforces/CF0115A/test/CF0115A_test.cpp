...
class CF0115A_PartyTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(CF0115A_PartyTest, PartyTest)
{
...
INSTANTIATE_TEST_CASE_P(
    CF0115A_PartyTests, CF0115A_PartyTest,
    ::testing::Values(std::make_pair("Codeforces/CF0115A/data/0_in.txt","Codeforces/CF0115A/data/0_out.txt")));
// clang-format on
