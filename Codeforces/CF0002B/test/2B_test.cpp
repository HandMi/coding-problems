...
class CF0002B_CountFactorTest
    : public testing::TestWithParam<std::pair<int, std::pair<int, int>>>
{
};

TEST_P(CF0002B_CountFactorTest, CountCorrectFactors)
{
...
INSTANTIATE_TEST_CASE_P(
    CF0002B_CountFactorTests, CF0002B_CountFactorTest,
    ::testing::Values(std::make_pair(10, std::make_pair(1, 1)),
                      std::make_pair(2, std::make_pair(1, 0))));

class CF0002B_FindShortestWeightedPathTest
    : public testing::TestWithParam<std::pair<GridType, int>>
{
};

TEST_P(CF0002B_FindShortestWeightedPathTest, FindShortestPath)
{
...
// clang-format off
INSTANTIATE_TEST_CASE_P(
    CF0002B_FindShortestWeightedPathTests, CF0002B_FindShortestWeightedPathTest,
...
class CF0002B_ReconstructPathTest
    : public testing::TestWithParam<std::pair<DirectionType, std::string>>
{
};

TEST_P(CF0002B_ReconstructPathTest, ReconstructPath)
{
...
// clang-format off
INSTANTIATE_TEST_CASE_P(
    CF0002B_ReconstructPathTests, CF0002B_ReconstructPathTest,
...
class CF0002B_PathThroughZeroTest
    : public testing::TestWithParam<
          std::pair<std::vector<std::size_t>, std::string>>
{
};

TEST_P(CF0002B_PathThroughZeroTest, PathThroughZero)
{
    const auto parameters = GetParam().first;
    const auto expected = GetParam().second;
...
// clang-format off
INSTANTIATE_TEST_CASE_P(
    CF0002B_PathThroughZeroTests, CF0002B_PathThroughZeroTest,
