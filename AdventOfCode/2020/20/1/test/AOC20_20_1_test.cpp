...
class AOC20_20_1_JurassicJigsawTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(AOC20_20_1_JurassicJigsawTest, JurassicJigsawTest)
{
...
INSTANTIATE_TEST_CASE_P(
    AOC20_20_1_JurassicJigsawTests, AOC20_20_1_JurassicJigsawTest,
    ::testing::Values(std::make_pair("AdventOfCode/2020/20/1/data/0_in.txt","AdventOfCode/2020/20/1/data/0_out.txt")));
// clang-format on
