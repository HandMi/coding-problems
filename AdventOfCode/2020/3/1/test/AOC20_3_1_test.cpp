...
class AOC20_3_1_TobogganTrajectoryTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(AOC20_3_1_TobogganTrajectoryTest, TobogganTrajectoryTest)
{
...
INSTANTIATE_TEST_CASE_P(
    AOC20_3_1_TobogganTrajectoryTests, AOC20_3_1_TobogganTrajectoryTest,
    ::testing::Values(std::make_pair("AdventOfCode/2020/3/1/data/0_in.txt","AdventOfCode/2020/3/1/data/0_out.txt")));
// clang-format on
