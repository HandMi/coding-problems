...
class AOC20_21_1_AllergenAssessmentTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(AOC20_21_1_AllergenAssessmentTest, AllergenAssessmentTest)
{
...
INSTANTIATE_TEST_CASE_P(
    AOC20_21_1_AllergenAssessmentTests, AOC20_21_1_AllergenAssessmentTest,
    ::testing::Values(std::make_pair("AdventOfCode/2020/21/1/data/0_in.txt","AdventOfCode/2020/21/1/data/0_out.txt")));
// clang-format on
