...
class AOC20_21_2_AllergenAssessmentTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(AOC20_21_2_AllergenAssessmentTest, AllergenAssessmentTest)
{
...
INSTANTIATE_TEST_CASE_P(
    AOC20_21_2_AllergenAssessmentTests, AOC20_21_2_AllergenAssessmentTest,
    ::testing::Values(std::make_pair("AdventOfCode/2020/21/2/data/0_in.txt","AdventOfCode/2020/21/2/data/0_out.txt")));
// clang-format on
