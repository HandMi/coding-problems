...
class AOC20_5_1_BinaryBoardingTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(AOC20_5_1_BinaryBoardingTest, BinaryBoardingTest)
{
...
INSTANTIATE_TEST_CASE_P(
    AOC20_5_1_BinaryBoardingTests, AOC20_5_1_BinaryBoardingTest,
    ::testing::Values(std::make_pair("AdventOfCode/2020/5/1/data/0_in.txt","AdventOfCode/2020/5/1/data/0_out.txt")));
// clang-format on
