...
class AOC20_22_1_CrabCombatTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(AOC20_22_1_CrabCombatTest, CrabCombatTest)
{
...
INSTANTIATE_TEST_CASE_P(
    AOC20_22_1_CrabCombatTests, AOC20_22_1_CrabCombatTest,
    ::testing::Values(std::make_pair("AdventOfCode/2020/22/1/data/0_in.txt","AdventOfCode/2020/22/1/data/0_out.txt")));
// clang-format on
