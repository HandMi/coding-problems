...
class AOC20_02_1_PasswordPhilosophyTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(AOC20_02_1_PasswordPhilosophyTest, PasswordPhilosophyTest)
{
...
INSTANTIATE_TEST_CASE_P(
    AOC20_02_1_PasswordPhilosophyTests, AOC20_02_1_PasswordPhilosophyTest,
    ::testing::Values(std::make_pair("AdventOfCode/2020/02/1/data/0_in.txt","AdventOfCode/2020/02/1/data/0_out.txt")));
// clang-format on
