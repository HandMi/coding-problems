...
class AOC20_02_2_PasswordPhilosophyTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(AOC20_02_2_PasswordPhilosophyTest, PasswordPhilosophyTest)
{
...
INSTANTIATE_TEST_CASE_P(
    AOC20_02_2_PasswordPhilosophyTests, AOC20_02_2_PasswordPhilosophyTest,
    ::testing::Values(std::make_pair("AdventOfCode/2020/02/2/data/0_in.txt","AdventOfCode/2020/02/2/data/0_out.txt")));
// clang-format on
