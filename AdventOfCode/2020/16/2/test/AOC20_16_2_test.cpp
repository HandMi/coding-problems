...
class AOC20_16_2_TicketTranslationTest
    : public testing::TestWithParam<std::pair<std::string, std::string>> {};

TEST_P(AOC20_16_2_TicketTranslationTest, TicketTranslationTest) {
...
INSTANTIATE_TEST_CASE_P(
    AOC20_16_2_TicketTranslationTests, AOC20_16_2_TicketTranslationTest,
    ::testing::Values(std::make_pair("AdventOfCode/2020/16/2/data/0_in.txt","AdventOfCode/2020/16/2/data/0_out.txt")));
// clang-format on
