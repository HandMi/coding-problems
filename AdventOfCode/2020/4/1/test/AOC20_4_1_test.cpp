...
class AOC20_4_1_PassportProcessingTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(AOC20_4_1_PassportProcessingTest, PassportProcessingTest)
{
...
INSTANTIATE_TEST_CASE_P(
    AOC20_4_1_PassportProcessingTests, AOC20_4_1_PassportProcessingTest,
    ::testing::Values(std::make_pair("AdventOfCode/2020/4/1/data/0_in.txt","AdventOfCode/2020/4/1/data/0_out.txt")));
// clang-format on
