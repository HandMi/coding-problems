...
class AOC20_08_2_HandheldHaltingTest
    : public testing::TestWithParam<std::pair<std::string, std::string>>
{
};

TEST_P(AOC20_08_2_HandheldHaltingTest, HandheldHaltingTest)
{
...
INSTANTIATE_TEST_CASE_P(
    AOC20_08_2_HandheldHaltingTests, AOC20_08_2_HandheldHaltingTest,
    ::testing::Values(std::make_pair("AdventOfCode/2020/08/2/data/0_in.txt","AdventOfCode/2020/08/2/data/0_out.txt")));
// clang-format on
